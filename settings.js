//ITHARA PIDAKKNA MEENO🧐
const fs = require('fs')

// Api
global.APIs = {
	thoppi: 'https://api.zeeoneofc.my.id',
}

// Apikey
global.APIKeys = {
	'https://api.zeeoneofc.my.id': 'njathlR2EJWruxO',
}
//Allahn muthee...
global.namabot = "「 ͲᎻϴᏢᏢᏆ-ᎷᎠツ」"
global.namaowner = "ʜᴜsɴɪ"
global.packname = namabot
global.author = namaowner
global.myweb = "https://instagram.com/huxniee"
global.footer_text = "© " + namabot
global.pp_bot = fs.readFileSync("./image/thoppi.jpg")
global.owner = ['919567749726']
global.sessionName = 'session'
global.background = "https://telegra.ph/file/40342e0085d521cb8b907.jpg" //max size 50 kb so the welcome isn't slow
global.prefa = ['-_-']
global.grup_only = false //bots can only be used in groups if true
global.mess = {
    done: 'ᴇɴᴛʜᴀᴀɴ ʙʀᴏ ᴍᴏᴅᴀʏᴀɴᴏ🗿...',
    wait: '_ᴡ𝟾 ᴄʜᴇʏ ʙʀᴜʜʜ🗿 ',
    admin: 'ɴᴇᴇ ᴘᴏᴅᴀ ᴄʜɪʟʟ ᴄʜᴇᴋᴋᴀ😏...',
    botNotAdmin: '📌ᴍᴀᴋᴇ ʙᴏᴛ ᴀs ᴀᴅᴍɪɴ ғɪʀsᴛ',
    owner: 'ɴᴇᴇ ᴘᴏᴅᴀ ᴄʜɪʟʟ ᴄʜᴇᴋᴋᴀ😏...',
    group: 'ᴛʜɪs ᴄᴏᴍᴍᴀɴᴅ ᴏɴʟʏ ғᴏʀ ɢʀᴏᴜᴘ ',
}
global.butwel =  [{
   buttonId: '.help',
   buttonText: {
...
global.help = {
menu(pushname, mundur, upload, download, totalGb, usedGb, freeGb, ownerName, botName, jam, tanggal, runtime, prefix){
  return `
*ɪᴛʜᴀʀᴀ ᴘɪᴅᴀᴋᴋɴᴀ ᴍᴇᴇɴᴏ😌*
${pushname}
...
┆❐ ${prefix}guessimage
┆❐ ${prefix}guessword
┆❐ ${prefix}guess the flag
┆❐ ${prefix}guesssentence
┆❐ ${prefix}guess who
┆❐ ${prefix}guessregency
┆❐ ${prefix}tebakkota
┆❐ ${prefix}tebakkimia
